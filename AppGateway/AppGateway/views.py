...
from AppGateway import app, server
...
The POST request should contain job attributes either in JSON format or as FORM </br>
data:</br>
</br>
...
The request will return an job ID e.g.: MultiNest_40ecad7d-41be-48bc-9d87-131f894052a8_nlfsvY</br>
</br>
* Verifying job status</br>
Job status can be queried by GET on [host]/status/[id]. Where [id] is the string</br>
returned during submission.</br>
</br>
    curl [host]/status/MultiNest_40ecad7d-41be-48bc-9d87-131f894052a8_nlfsvY</br>
</br>
The request returns: "queued", "running", "done" or an error.</br>
</br>
* Job output</br>
The http/ftp base URL for the output files is retrieved as [host]/output/[id]</br>
</br>
    curl [host]/output/MultiNest_40ecad7d-41be-48bc-9d87-131f894052a8_nlfsvY</br>
</br>
* Job can be scheduled for removal: [host]/delete/[id]</br>
</br>
    curl [host]/delete/MultiNest_40ecad7d-41be-48bc-9d87-131f894052a8_nlfsvY</br>
</br>
* Possible improvements:</br>
    Authentication using OpenID. This would allow to query users jobs. With</br>
    addition of "Name" job atribute this would allow to generate a user readable</br>
    job list.</br>
"""
    return help
